  ...
  return (
    <Container className="flex flex-col gap-4">
      ...
      <p>
        ...
        then clicking a link, we will often experience a blocked navigation with
        the slow posts.
      </p>
      <p>
        ...
        is counter intuitive, as we would expect both approaches to immediately
        render the static parts of the page while the suspense content streams
        in with fallback.
      </p>
    </Container>
  );
