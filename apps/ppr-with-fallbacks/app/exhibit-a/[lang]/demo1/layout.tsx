  ...
  return (
    ...
    >
      <aside className="flex flex-col gap-4 w-40 shrink-0 ">
        {/* 
        This should require suspense, but it doesn't because pages further down the tree have generateStaticParams for [postId].
        It would fail otherwise, since NavLink uses `usePathname()`.
        */}
