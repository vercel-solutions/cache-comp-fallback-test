  ...
  return (
    <Container className="flex flex-col gap-4">
      <p className="text-xs leading-relaxed">
        These demos illustrate the different behaviors of suspense fallbacks,
        blocking navigation, and static vs dynamic content.
      </p>
      <p className="text-xs leading-relaxed">
      ...
      <p className="text-xs leading-relaxed">
        The post API applies <Code>"use cache: remote"</Code>, simulating a 2.5s
        request time initially.
      </p>
    </Container>
  );
}
